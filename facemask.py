...
for dirname, _, filenames in os.walk("C:\\Users\\joldi\\Desktop\\face-mask-detection"):
...
#%%
imgs = list(sorted(os.listdir("C:\\Users\\joldi\\Desktop\\face-mask-detection\\images")))
print(len(imgs))

#%%
labels = list(sorted(os.listdir("C:\\Users\\joldi\\Desktop\\face-mask-detection\\annotations")))
...
for i in range(853):
    ...
    img_path = os.path.join("C:\\Users\\joldi\\Desktop\\face-mask-detection\\images", file_image)
    label_path = os.path.join("C:\\Users\\joldi\\Desktop\\face-mask-detection\\annotations", file_label)
    #Generate Label
...
for i in range(853):
    ...
    img_path = r"C:\\Users\\joldi\\Desktop\\face-mask-detection\\images\\maksssksksss{}.png".format(i)
    #read image
